...
plugin "rs_azure_containerservices" do
  ...
  type "containerservice" do
    href_templates "{{id}}"
    provision "provision_container_resources"
    delete    "delete_resource"
...
define provision_container_resources(@declaration) return @resource do
  sub on_error: stop_debugging(), timeout: 60m do
