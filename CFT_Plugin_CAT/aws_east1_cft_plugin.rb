name 'rs_aws_useast1_cft'
type 'plugin'
rs_ca_ver 20161221
short_description "Amazon Web Services - Cloud Formation"
long_description "Version: 1.3"
package "plugins/rs_aws_useast1_cft"
import "sys_log"


resource_pool "rs_aws_useast1_cft" do
  plugin $rs_aws_useast1_cft
...
define create_stack(@declaration) return @resource do
  sub on_error: stop_debugging() do
    ...
    @operation = rs_aws_useast1_cft.stack.create($fields)
    @operation = rs_aws_useast1_cft.stack.get_stack(stack_name: $stack_name)
